...
public class RestController {
	...
	public List<Person> getMembersJson() {
		...
		list.add(new Person("홍길동1", 20));
		list.add(new Person("홍길동2", 30));
		list.add(new Person("홍길동3", 40));
		list.add(new Person("홍길동4", 50));
		list.add(new Person("홍길동5", 60));
	...
	public Map<String, Person> getMembersXLM2() {
		Map<String, Person> map = new HashMap<>();
